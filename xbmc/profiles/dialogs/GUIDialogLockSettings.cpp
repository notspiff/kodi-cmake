...
void CGUIDialogLockSettings::InitializeSettings()
{
  ...
  if (m_getUser)
  {
    ...
    AddEdit(group, SETTING_PASSWORD, 12326, 0, &m_password, false, true);
  ...
  if (m_details)
  {
    ...
    AddSpinner(groupDetails, SETTING_LOCK_SETTINGS, 20043, 0, (int*)&m_locks.settings, settingsLevelOptions);
