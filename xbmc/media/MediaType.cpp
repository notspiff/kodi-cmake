...
static std::map<std::string, MediaTypes::MediaTypeInfo> fillDefaultMediaTypes()
{
  ...
  mediaTypes.insert(std::make_pair(MediaTypeMusic,            MediaTypes::MediaTypeInfo(MediaTypeMusic,           MediaTypeMusic,               36914, 36915,   249,   249)));
  mediaTypes.insert(std::make_pair(MediaTypeArtist,           MediaTypes::MediaTypeInfo(MediaTypeArtist,          MediaTypeArtist "s",          36916, 36917,   557,   133)));
  mediaTypes.insert(std::make_pair(MediaTypeAlbum,            MediaTypes::MediaTypeInfo(MediaTypeAlbum,           MediaTypeAlbum "s",           36918, 36919,   558,   132)));
  mediaTypes.insert(std::make_pair(MediaTypeSong,             MediaTypes::MediaTypeInfo(MediaTypeSong,            MediaTypeSong "s",            36920, 36921,   172,   134)));
  mediaTypes.insert(std::make_pair(MediaTypeVideo,            MediaTypes::MediaTypeInfo(MediaTypeVideo,           MediaTypeVideo "s",           36912, 36913,   291,     3)));
  mediaTypes.insert(std::make_pair(MediaTypeVideoCollection,  MediaTypes::MediaTypeInfo(MediaTypeVideoCollection, MediaTypeVideoCollection "s", 36910, 36911, 20141, 20434)));
  mediaTypes.insert(std::make_pair(MediaTypeMusicVideo,       MediaTypes::MediaTypeInfo(MediaTypeMusicVideo,      MediaTypeMusicVideo "s",      36908, 36909, 20391, 20389)));
  mediaTypes.insert(std::make_pair(MediaTypeMovie,            MediaTypes::MediaTypeInfo(MediaTypeMovie,           MediaTypeMovie "s",           36900, 36901, 20338, 20342)));
  mediaTypes.insert(std::make_pair(MediaTypeTvShow,           MediaTypes::MediaTypeInfo(MediaTypeTvShow,          MediaTypeTvShow "s",          36902, 36903, 36902, 36903)));
  mediaTypes.insert(std::make_pair(MediaTypeSeason,           MediaTypes::MediaTypeInfo(MediaTypeSeason,          MediaTypeSeason "s",          36904, 36905, 20373, 33054)));
  mediaTypes.insert(std::make_pair(MediaTypeEpisode,          MediaTypes::MediaTypeInfo(MediaTypeEpisode,         MediaTypeEpisode "s",         36906, 36907, 20359, 20360)));
