...
{
public:
  CTvShowImportHandler() { }
  virtual ~CTvShowImportHandler() { }

  virtual IMediaImportHandler* Create() const { return new CTvShowImportHandler(); }

  virtual MediaType GetMediaType() const { return MediaTypeTvShow; }
