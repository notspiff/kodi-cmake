...
namespace XBMCAddon
{
  namespace xbmcgui
  {
    ...
    public:
       ...
       * time            : float - Scroll time
       * repeat          : float - Repeat time
       *
       * example:
       *   - self.textbox.autoScroll(0.5, 2.0, 1.0)
       */
      virtual void autoScroll(float delay, float time,
                              float repeat) throw(UnimplementedException);
