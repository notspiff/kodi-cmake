    ...
    m_responseRanges()
{
  ...
  if (m_response.status != MHD_HTTP_OK ||
      ...
      boost::dynamic_pointer_cast<ADDON::CWebinterface>(m_addon)->GetType() == ADDON::WebinterfaceTypeStatic)
  {
  ...
  m_type = boost::dynamic_pointer_cast<ADDON::CWebinterface>(m_addon)->GetType();
