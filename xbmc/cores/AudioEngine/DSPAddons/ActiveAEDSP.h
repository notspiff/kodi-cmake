...
namespace ActiveAE
{
  ...
  //@{
    /*!
     * @brief Translate audio dsp channel flag to XBMC channel flag
     */
    static enum AEChannel GetXBMCChannel(AE_DSP_CHANNEL channel);

    /*!
     * @brief Translate XBMC channel flag to audio dsp channel flag
     */
