...
namespace ActiveAE
{
  ...
  public:
    ...
    /*!
     * @brief Create a XBMC internal processing mode infomation class
     ...
     * @return true if internal XBMC mode
     */
  ...
  private:
    ...
    bool              m_bIsInternal;             /*!< true if this mode is an internal XBMC mode */
    std::string       m_strModeName;             /*!< the log name of this mode on the Addon or inside XBMC */
    //@}
